...
function isPrime(string $Number) {
	...
	for ($i = "7"; bccomp($i, $Root) === -1; $i = bcadd($i, "6")) {
		if (bcmod($Number, $i) === 0) {
			echo "Divisible by $i".PHP_EOL;
			return false;
		}

		if (bcmod($Number, bcadd($i, "2")) === 0) {
			echo "Divisible by $i + 2".PHP_EOL;
			return false;
		}
	}
...
// Prime - 1.58772993 seconds
// Prime - 0.00000882 seconds
// Prime - 2.49749589 seconds
// Prime - 0.00001001 seconds
// Prime - 1.77857900 seconds
// Prime - 0.00001001 seconds
// Prime - 2.37616420 seconds
// Prime - 0.00001097 seconds
// Prime - 0.00000191 seconds
// Prime - 1.69502401 seconds